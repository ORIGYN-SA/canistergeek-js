...
const getContentComponent = (section) => {
    switch (section) {
        case 'summary':
            return [
                React.createElement(LogMessagesSummarySectionComponent_1.LogMessagesSummarySectionComponent, null),
                React.createElement(antd_1.Space, { direction: 'horizontal' },
...
const CanistergeekLogMessagesPage = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(antd_1.PageHeader, { title: `${Constants_1.PRODUCT_NAME}: Log Messages`, 
...
const stringInject = (str, data) => {
    ...
    else if ((typeof str === 'string' && data instanceof Array === false) ||
