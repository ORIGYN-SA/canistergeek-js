...
exports.createCanisterActor = exports.idlFactory = void 0;
...
const createActor = (canisterId, options, httpAgent) => {
    const agent = httpAgent || new agent_1.HttpAgent({ ...options === null || options === void 0 ? void 0 : options.agentOptions });
    ...
    return agent_1.Actor.createActor(exports.idlFactory, {
        agent,
        canisterId,
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canistergeek.did.d.ts")._SERVICE>}
 */
const createCanisterActor = (canisterId, identity, host, httpAgent) => {
